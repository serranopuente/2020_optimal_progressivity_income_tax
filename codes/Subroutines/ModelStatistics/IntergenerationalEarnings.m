function IntergenerationalEarningsCorr=IntergenerationalEarnings(Nsim,StationaryDist, Policy, Phi_aprimeKron, n_d,n_a,n_z,d_grid, Gamma, e,w,J)
...
for a_c=1:N_a
    for s_c=1:N_s
        for sprime_c=1:N_s
            ...
            P(a_c,s_c,optaprime,sprime_c)=gather(Gamma(s_c,sprime_c)/sum(Gamma(s_c,:)));
        end
    end
end
