function SSvalues_AggVars=SSvalues_AggVars_vec(StationaryDist, PolicyIndexes, FnsToEvaluateFn, FnsToEvaluateFnParamsVec, n_d, n_a, n_z, d_grid, a_grid, z_grid)
...
for i=1:length(FnsToEvaluateFn)
    % Includes check for cases in which no parameters are actually required
        SSvalueParamsCell=num2cell(FnsToEvaluateFnParamsVec);
