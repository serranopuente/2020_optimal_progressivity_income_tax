function Fmatrix=CreateReturnFnMatrix_CEV(ReturnFn_CEV, CEV, n_d, n_a, n_z, d_grid, a_grid, z_grid, ReturnFnParamsVec)
...
Fmatrix=zeros(N_d,N_a,N_z);
    parfor i3=1:N_z
        ...
        for i1=1:N_d
            for i2=1:N_a
                Fmatrix_z(i1,i2)=ReturnFn_CEV(CEV,d_gridvals(i1,1),d_gridvals(i1,2),a_gridvals(i2,1),z_gridvals_temp,ReturnFnParamsCell{:});
            end
        end
